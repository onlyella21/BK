...
$pdf->Cell(250,7,'DAFTAR SISWA SMK ITIKURIH HIBARNA',0,1,'C');
...
include'koneksi.php';
$maha=mysqli_query($koneksi,"SELECT * FROM tab_siswa as s JOIN tab_kelas as k ON s.id_kelas=k.id_kelas");
...
$pdf->Cell(25,8,$row['angkatan'],1,0);
