...
<div class="row" id="contentInput" >
       ...
       <div class="panel panel-info">
          ...
          <div class="form-group form-group-sm">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-4">
                    <input type="text" class="form-control" name="txtcari" id="txtcari" placeholder="Nama Siswa">
                </div>
      ...
      <div class="table-responsive-sm">
              <table class="table table-bordered  table-hover table-striped">
                <tr>
                  <th><a href="tambah_konsultasi.php" type="button" align="right" class="btn btn-success">Tambah Data</a></th>
                </tr>
                <tr>
                  <th>NO</th>
                  <th>Kode Konsul</th>
      ...
      if(!ISSET($_POST['cari'])){
        $no= 1;
        $query="SELECT * FROM tab_konsultasi as k JOIN tab_siswa as s ON k.nis=s.nis JOIN tab_kelas as e ON e.id_kelas=s.id_kelas";
      ...
      ?>
       ...
       if(ISSET($_POST['cari'])){
        ...
        $perintah="SELECT * FROM tab_konsultasi as k JOIN tab_siswa as s ON k.nis=s.nis JOIN tab_kelas as e ON e.id_kelas=s.id_kelas WHERE s.nama_siswa LIKE '%$cari%'" ;
