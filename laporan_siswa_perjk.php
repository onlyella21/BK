...
include'koneksi.php';
if(@$_POST['cetak']){
        $id=mysqli_real_escape_string($koneksi,$_POST['jk']);
        $maha=mysqli_query($koneksi,"SELECT * FROM tab_siswa as s JOIN tab_kelas as k ON s.id_kelas=k.id_kelas where s.jenis_kelamin='$id'");
...
$pdf->Cell(190,7,'Jenis Kelamin: '.$ko,0,1,'L');
...
$pdf->Cell(27,8,$row['angkatan'],1,0);
