...
<div class="row" id="contentInput" >
          <div class="col-lg-12">
            <h1>Laporan Konsultasi Siswa</h1>
            <ol class="breadcrumb">
              <li class="active"> Laporan</li>
              <li class="active">Laporan Konsultasi Siswa</li>
            </ol>
          </div>
      </div>
          ...
          <div class="panel-body">
                    <a   href="laporan_semua_konsultasi.php" type="button" class="btn btn-success"><i class="fa fa-edit"></i>Cetak Semua Data Konsultasi Siswa</a>
               <hr>     
           

          <!-------------form berdasarkan kelas-->
         <h4>Cetak Per Siswa-----------------------</h4>
          <form method="POST" action="" id="persiswa">
       ...
       <form method="POST" action="" id="carinis">
          <div class="form-group form-group-sm">
              ...
              ?>
               <form method="POST" action="laporan_konsultasi_persiswa.php" id="pertgl">
                 <div class="form-group form-group-sm">
...
?>
 ...
 <h4 >Cetak Per Tanggal-----------------</h4>
  ...
  <form method="POST" action="laporan_konsultasi_pertanggal.php" id="pertgl">
                 <div class="form-group form-group-sm">
